export default {
  ...
  'menu.business': '医联业务应用',
  'menu.business.medical-card-inquiry': '就诊卡查询',
  'menu.business.registration-appointment-inquiry': '预约查询',
  'menu.business.performance-statistics': '业绩统计',
  'menu.business.application-dissemination': '应用推广',
  'menu.business.dissemination-data-statistics': '推广数据统计',
  'menu.business.registration-appointment-data-statistics': '预约数据统计',
  ...
  'menu.account.reset-password': '重置密码',
